...
path = r'D:\\Google Drive\\Masters Research - Supercapacitor\\Data\\EC data\\2 Electrode\\Swagelok T-Type\\Pristine H2SO4 rerun\\post activation\\CV\\SR\\' # path name - be sure to use // instead of / for Windows
...
plt.legend()
plt.grid()
fig.savefig(path+'Scan rates for Pristine MX (post activation).png')
plt.show()
