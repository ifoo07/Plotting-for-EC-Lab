...
sname = ['CV_sr_02_CV_C01','CV_sr_03_CV_C01','CV_sr_04_CV_C01','CV_sr_05_CV_C01','CV_sr_06_CV_C01','CV_sr_07_CV_C01'] # file names of data to be plotted
scanrate = [40,50,75,100,150,200] #scan rates from data
labels = ['40mV/s','50mV/s','75mV/s','100mV/s','150mV/s','200mV/s'] #scan rate labels, must correlate with above
mass = 0.00328 #g - mass of active material
# mass = [0.00328,0.00304,0.00328]
...
plt.legend()
plt.grid()
fig.savefig(path+'Scan rates for Pristine MX KEN.png')
plt.show()
