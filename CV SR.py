...
path = r'D:\\Google Drive\\Masters Research - Supercapacitor\\Data\\EC data\\2 Electrode\\Swagelok T-Type\\Repeats\\Pristine MXene\\Pristine MX rerun\\CV\\SR\\' # path name - be sure to use // instead of / for Windows
sname = ['CV_sr_01_CV_C01','CV_sr_02_CV_C01','CV_sr_03_CV_C01','CV_sr_04_CV_C01','CV_sr_05_CV_C01','CV_sr_06_CV_C01','CV_sr_07_CV_C01','CV_sr_08_CV_C01','CV_sr_09_CV_C01'] # file names of data to be plotted
...
mass = 0.00384 #g - mass of active material
...
plt.legend()
plt.grid()
fig.savefig(path+'Scan rates for Pristine MX.png')
plt.show()
